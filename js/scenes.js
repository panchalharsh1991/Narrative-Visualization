...
function createOffenseCountBars(data) {
...
function animateScene0() {
    initializeChartArea();
    calculateScales(offenseGroups);

    createOffenseCountBars(offenseGroups);
...
function animateScene1() {
	initializeChartArea();
    calculateScales(offensesByDay);

    createOffenseCountBars(offensesByDay);
	showOffenseCountBars();
	createOffenseCountAxis();
	showOffenseCountAxis();
