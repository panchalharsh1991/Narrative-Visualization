...
function showDaysAxis() {
    ...
    d3.select(".chart").append("g")
        .attr("id", "xAxisG")
        .classed("x axis",true)
        .attr("transform", "translate(" + (margin.left-4) + "," + (margin.top + chart_dimensions.height) + ")")
        .call(xAxis)
        .selectAll("text")
        .attr("x", -20)
        .attr("y", 10)
...
function showHoursAxis() {
    ...
    d3.select(".chart").append("g")
        .attr("id", "xAxisG")
        .classed("x axis",true)
        .attr("transform", "translate(" + (12+margin.left) + "," + (margin.top + chart_dimensions.height) + ")")
        .call(xAxis)
        .selectAll("text")
        .attr("x", -3)
        .attr("y", 20)
...
function showMonthsAxis() {
    ...
    d3.select(".chart").append("g")
        .attr("id", "xAxisG")
        .classed("x axis",true)
        .attr("transform", "translate(" + (8+margin.left) + "," + (margin.top + chart_dimensions.height) + ")")
        .call(xAxis)
        .selectAll("text")
        .attr("x", -20)
        .attr("y", 10)
