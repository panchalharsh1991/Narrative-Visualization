...
var div = d3.select("body").append("div");
	...
	d3.select(".col-xs-3").insert("p").text("The graph shows crimes reported over 3 years and their frequency by type of a crime.");
	d3.select(".col-xs-3").insert("br");
	d3.select(".col-xs-3").insert("p").text("Larceny is by far the most common serious crime, and homicides are pretty rare.");
	d3.select(".col-xs-3").insert("br");
	d3.select(".col-xs-3").insert("p").text("Click on next slide for frequency of crimes happening over each month.");
